...
수집된 의견들을 분석하여 다음 2가지만 간결하게 작성해주세요:

1. **주요 의견 요약** (2-3줄): 가장 많이 나온 핵심 의견
2. **간략한 제안** (2-3줄): 의견을 취합한 실행 가능한 제안

매우 간결하고 핵심만 담아 선생님들이 빠르게 읽고 결정할 수 있도록 작성해주세요.`
          },
          {
            role: 'user',
