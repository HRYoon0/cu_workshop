    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 to-indigo-100">
        <div className="bg-white p-8 rounded-2xl shadow-xl max-w-md w-full text-center">
          ...
          <p className="text-gray-700 text-lg mb-2">진행 중인 의견 수집이 없습니다</p>
          <p className="text-gray-500">관리자가 의견 수집을 시작할 때까지 기다려주세요.</p>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 to-indigo-100">
        <div className="bg-white p-8 rounded-2xl shadow-xl max-w-md w-full text-center">
          ...
          <p className="text-sm text-gray-500">다음 논의 사항이 시작되면 다시 참여할 수 있습니다.</p>
        </div>
      </div>
    );
  }
